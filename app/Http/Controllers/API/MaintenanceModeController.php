...
class MaintenanceModeController extends Controller
{
    public function show(): JsonResponse
    {
        ...
        if (is_array($cached)) {
            return response()->json([
                ...
                'data' => [
                    ...
                    'variant' => MaintenancePageVariant::normalize($cached['variant'] ?? null),
        ...
        $data = [
            ...
            'variant' => MaintenancePageVariant::normalize((string) env('MAINTENANCE_MODE_VARIANT', MaintenancePageVariant::DEFAULT)),
